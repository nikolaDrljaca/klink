...
public class KlinkCleanupJob {
    ...
    private KlinkApplicationService klinkApplicationService;
    ...
    public void deleteExpiredKlinks() {
        ...
        if(!isDeleteScheduleTaskActive) {
            log.info(
                    "KlinkCleanupJob is not active, skipping deletion of expired Klinks");
            return;
        }
        log.info( "Deleting expired klinks..." );
        klinkApplicationService.deleteKlinksOlderThenDays();
    }
}
