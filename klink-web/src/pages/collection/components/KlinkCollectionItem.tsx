...
const KlinkCollectionItem: Component<KlinkListItemProps> = (props) => {
  ...
  return (
    <div class={classes()}>
      {/* Top Anchor */}
      <A
        class="flex flex-col w-full px-4 text-base-content hover:cursor-pointer"
        href={`/c/${props.item.id}`}
      >
      ...
      <div class="flex flex-row items-center justify-around w-full pt-4 pl-4">
        ...
        >
          <button
            ...
            onClick={editModal.controller.open}
          >
            <Edit size={14} />
          </button>
        </div>
        ...
        >
          <button
            class="btn btn-circle btn-ghost btn-sm"
            onClick={shareModal.controller.open}
          >
            <Share2 size={14} />
          </button>
        </div>
        ...
        >
          <button
            ...
            onClick={() => deleteModal.controller.open()}
          >
            <Trash size={14} />
          </button>
        </div>
